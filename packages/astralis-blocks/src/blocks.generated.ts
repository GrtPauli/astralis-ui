...
export const blocks = {
  "contact-01": {
    meta: {
      ...
      component: "Contact01",
      uses: ["Box","Button","Container","Field","FieldLabel","Flex","Grid","Heading","Icon","Input","InputTextarea","Link","Stack","Text"],
    },
    component: Contact01,
  },
  "contact-02": {
    meta: {
      ...
      component: "Contact02",
      uses: ["Box","Button","Container","Field","FieldLabel","Flex","Grid","GridItem","Heading","Input","InputTextarea","Select","Stack","Text"],
    },
    component: Contact02,
  },
  "contact-03": {
    meta: {
      ...
      component: "Contact03",
      uses: ["Box","Button","Container","Field","FieldLabel","Flex","Grid","Heading","Icon","Input","InputTextarea","Stack","Text"],
    },
    component: Contact03,
  },
  "cta-01": {
  ...
  "dashboard-01": {
    meta: {
      ...
      uses: ["Avatar","Badge","Box","Breadcrumb","BreadcrumbItem","BreadcrumbLink","Flex","Grid","Icon","Input","Kbd","Stack","Text"],
    },
    component: Dashboard01,
  },
  "dashboard-02": {
  ...
  "forgot-password-01": {
    meta: {
      ...
      uses: ["Box","Button","Container","Field","FieldHelpText","FieldLabel","Flex","Heading","Icon","Input","Link","Stack","Text"],
    },
    component: ForgotPassword01,
  },
  "hero-01": {
  ...
  "hero-03": {
    meta: {
      ...
      files: ["hero-03.tsx"],
      component: "Hero03",
      uses: ["Box","Button","Card","CardBody","Container","Flex","Grid","Heading","Icon","List","ListItem","Stack","Text"],
    },
    component: Hero03,
  },
  "login-01": {
    meta: {
      ...
      files: ["login-01.tsx"],
      component: "Login01",
      uses: ["Box","Button","Checkbox","Container","Field","FieldLabel","Flex","FlexItem","Heading","Icon","Input","InputPassword","Link","Separator","Stack","Text"],
    },
    component: Login01,
  },
  "navbar-01": {
  ...
  "signup-01": {
    meta: {
      ...
      files: ["signup-01.tsx"],
      component: "Signup01",
      uses: ["Box","Button","Checkbox","Container","Field","FieldHelpText","FieldLabel","Flex","FlexItem","Heading","Icon","Input","InputPassword","Link","List","ListItem","Separator","Stack","Text"],
    },
    component: Signup01,
  },
  "stats-01": {
